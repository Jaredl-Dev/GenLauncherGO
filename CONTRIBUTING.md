...
and verifies the supported single-file publish profile. A separate weekly workflow audits vulnerable and deprecated
dependencies.
...
Mutation testing locally evaluates whether behavior is meaningfully asserted. It covers every behavior-bearing file in
