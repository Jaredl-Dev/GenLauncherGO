...
public sealed class ModificationTileImageProviderTests
{
    ...
    public void LoadGrayscaleImageForMod_LoadsCachedImageWhenPresent()
    {
        ...
        imageFileService.FindExistingImageFilePath(ModificationType.Mod, "ShockWave", "1.0").Returns(imagePath);
    ...
    public void LoadColorImageForNonMod_ReturnsNullWithoutImageLookup()
    {
        ...
        imageFileService.DidNotReceive().FindExistingImageFilePath(
            Arg.Any<ModificationType>(),
            Arg.Any<string>(),
            Arg.Any<string>());
    }
    ...
    {
        IModificationImageFileService imageFileService = Substitute.For<IModificationImageFileService>();
        imageFileService.FindExistingImageFilePath(ModificationType.Mod, "ShockWave", "1.0")
            .Returns((string?)null);
    ...
    {
        IModificationImageFileService imageFileService = Substitute.For<IModificationImageFileService>();
        imageFileService.CountImageFiles(ModificationType.Advertising, ":Sponsor:").Returns(0);
        ModificationTileImageProvider provider = CreateProvider(imageFileService);
        ...
        result.Should().BeNull();
        imageFileService.Received(1).CountImageFiles(ModificationType.Advertising, ":Sponsor:");
    }
    ...
    public void LoadGrayscaleImageForAdvertising_LoadsExistingIndexedImage()
    {
        ...
        IModificationImageFileService imageFileService = Substitute.For<IModificationImageFileService>();
        imageFileService.CountImageFiles(ModificationType.Advertising, "Sponsor").Returns(2);
        imageFileService.FindExistingImageFilePath(
    ...
    public void LoadColorImage_DeletesUnreadableCachedModImageAndUsesDefaultImage()
    {
        ...
        result.Should().NotBeNull();
        imageFileService.Received(1).TryDeleteImage(ModificationType.Mod, "ShockWave", "1.0");
    }
    ...
    public void LoadGrayscaleImage_ReturnsNullWhenUnreadableAdvertisingImageCannotBeDeleted()
    {
        ...
        imageFileService.ImageExists(imagePath).Returns(true);
        imageFileService
            .When(service => service.TryDeleteImage(
                ModificationType.Advertising,
                "Sponsor",
                Arg.Any<string>()))
        ...
        result.Should().BeNull();
        imageFileService.Received(1).TryDeleteImage(
            ModificationType.Advertising,
            "Sponsor",
            Arg.Any<string>());
    }
