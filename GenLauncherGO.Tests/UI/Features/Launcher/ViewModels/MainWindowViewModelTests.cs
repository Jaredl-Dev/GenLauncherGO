...
public sealed class MainWindowViewModelTests
{
    ...
    public async Task ShowContentViewAsync_WhenOriginalGameContentIsRequired_LoadsContentAndShowsPatchViewAsync()
    {
        ...
        await viewModel.ShowContentViewAsync(LauncherContentViewKind.Patches, TestContext.Current.CancellationToken);
        ...
        bool showAddons)
    {
        ...
        await viewModel.ShowContentViewAsync(viewKind, TestContext.Current.CancellationToken);
    ...
    public async Task RepositoryAddVisibility_TracksConnectivityAndActiveContentViewAsync(bool connected)
    {
        ...
        await viewModel.ShowContentViewAsync(LauncherContentViewKind.Modifications, TestContext.Current.CancellationToken);
